...
// is not a plain object of booleans falls back to the shipped defaults
// rather than mislabelling every row.
function sanitizeSlack(v) {
  if (!isPlainObject(v)) return {}
  var out = {}
  for (var k in v) {
    if (Object.prototype.hasOwnProperty.call(v, k) && typeof v[k] === "boolean")
      out[String(k).toLowerCase()] = v[k]
  }
  return out
}
